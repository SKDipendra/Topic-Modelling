...
df = pd.read_csv("corpus_revised3.csv", header=None, names=['id', 'primary_frame','text'])
...
train_inputs, validation_inputs, train_labels, validation_labels = train_test_split(input_ids, primary_frames, random_state=2018, test_size=0.1)

# Do the same for the masks.
train_masks, validation_masks, _, _ = train_test_split(attention_masks, primary_frames,random_state=2018, test_size=0.1)
...
learning_rate = [2e-4,2e-5,2e-7,3e-5,5e-5]
...
for i in learning_rate:
    ...
    epochs = 2# Total number of training steps is number of batches * number of epochs.
